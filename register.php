    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <br>
          ...
          <div class="comment-form-wrap pt-5">
                <h3 class="mb-5  text-center fw-bold">Register Now </h3>
                <form action="#" class="p-5 bg-light">
                  ...
                  <div class="form-group">
                    <input type="submit" value="Register Now" class="btn py-3 px-4 btn-primary">
                    <span>If you Already registered please <a href="login.php"> login</a>  </span>
                  </div>
